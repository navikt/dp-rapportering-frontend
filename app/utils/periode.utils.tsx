...
export function samleHtmlForPeriode(
  ...
  if (!periode.begrunnelseEndring) {
    ...
    html +=
      ...
      + aktivitetTypeMap("Arbeid", getAppText) + ": " + getAppText("rapportering-aktivitet-radio-arbeid-beskrivelse") + " " + getAppText("rapportering-antall-timer") + " " + renderToString(<PortableText value={getRichText("rapportering-input-tall-beskrivelse")} />) + "<br>"
      + aktivitetTypeMap("Syk", getAppText) + ": " + getAppText("rapportering-aktivitet-radio-syk-beskrivelse") + "<br>"
      + aktivitetTypeMap("Fravaer", getAppText) + ": " + getAppText("rapportering-aktivitet-radio-fravaer-beskrivelse") + "<br>"
      + aktivitetTypeMap("Utdanning", getAppText) + ": " + getAppText("rapportering-aktivitet-radio-utdanning-beskrivelse") + "<br>"
      + "<br>"
