...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:e098b34502fff1253f29125d2a70b313eb8283f16a633a40ba3dbfe8e949fa4a AS runtime
WORKDIR /app
