...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:8620802dd566f96e38e0cab1eac495d88d062ae65dbb73e63fbc0ed054124ddc AS runtime
WORKDIR /app
