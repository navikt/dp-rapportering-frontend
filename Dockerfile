...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:e402e2b6366a0618b756dd12ae038f5d6d3e81b8d0d962cb26d89122be739b64 AS runtime
WORKDIR /app
