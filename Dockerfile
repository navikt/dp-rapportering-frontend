FROM node:26-alpine@sha256:ef24c5053d50fdc3e4e56eb4e7ddb7861874ab0fdc797046ba897581deb8e868 AS node
RUN corepack enable
RUN corepack prepare pnpm@11.26.0 --activate
...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:5bef19af02c45a443f77aa2b1bdf7e4bcc967d3ba5bf94e6bd0c37e443418720 AS runtime
WORKDIR /app
