...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:8629a6e2f19027727fc1dbf14c6cd2765c126bcc655cd0bfb3ff299178cad23a AS runtime
WORKDIR /app
