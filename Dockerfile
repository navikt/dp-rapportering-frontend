...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:2e7f5631801ab5e353131007e9475d8b78466123844a96e6c703a23cf10aebc3 AS runtime
WORKDIR /app
