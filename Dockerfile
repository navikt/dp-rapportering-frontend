...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:201f2c3caa11b1d51d94f2ef8489b6ee0e9a7bf34405f71f544d1ffe201593f3 AS runtime
WORKDIR /app
