...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:512d5c1b4e9058d76e625383689311cd88cb66ffbb50618e49c36d3ced7af2ae AS runtime
WORKDIR /app
