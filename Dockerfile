...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:83f4d7a6cdeaeaf50c2dc3e8bc61b7c3766bb285ddcd22cd1e4a19df6bd369df AS runtime
WORKDIR /app
