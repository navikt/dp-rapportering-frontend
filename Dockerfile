...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:5e9aad1c918db85e556f887c58e9ceef7aa1672b9cbea463c3428b496321280c AS runtime
WORKDIR /app
