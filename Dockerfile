...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:c93fa236f43da5dd119fa1e0000772d3f9dae35d5fa8d06749e96cb11e582bc9 AS runtime
WORKDIR /app
