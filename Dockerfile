...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:24@sha256:0bd416b0faddc547edf3ccb8510d7e126cde2b37fd823b473d01e1416eedd066 AS runtime
WORKDIR /app
