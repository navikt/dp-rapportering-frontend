...
# runtime
FROM europe-north1-docker.pkg.dev/cgr-nav/pull-through/nav.no/node:26@sha256:43d8a68040cac5340972c1d33e807496630f854d64771baf765d80101ad024a8 AS runtime
WORKDIR /app
